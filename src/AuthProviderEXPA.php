    ...
    private function generateNewToken() {
        ...
        if($this->_session == "" || !file_exists($this->_session)) {
            ...
            while(!$success && $attempts < 3) {
                curl_setopt($req, CURLOPT_URL, 'https://auth.aiesec.org/oauth/authorize?redirect_uri=https%3A%2F%2Fexperience.aiesec.org%2Fsign_in&response_type=code&client_id=349321fd15814e9fdd2c5abe062a6fb10a27a95dd226fce287adb6c51d3de3df');
                $res = curl_exec($req);
                if($res !== false) {
                    $success = true;
